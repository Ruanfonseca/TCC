...
import TeachersList from "./pages/Management/Teacher/TeachersList";
import UsersList from "./pages/Management/User/UsersList";
import SchedulesList from "./pages/Management/Schedule/SchedulesList";
import RoomsList from "./pages/Management/Room/RoomsList";
import Agenda from "./pages/Agenda";
import Reports from "./pages/Reports";
import Support from "./pages/Support";
import NotFound from "./pages/NotFound";
import RequerimentoLaboratorio from "./pages/SolicitationLaboratorio/NewSolicitationLab";
import LabList from "./pages/Management/Lab/LabList";
